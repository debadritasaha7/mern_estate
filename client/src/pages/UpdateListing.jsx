...
<span className='text-xs'>($/month)</span>
        ...
        <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>{loading?'Uploading...':'Update Listing'}</button>
